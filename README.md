...
Starter notebook for AI4EO #MapYourCity ESA Challenge:    
 ...
 - An example DataLoader (in PyTorch) for the MapYourCity dataset can be found in: [src_model/MapYourCity_ExampleDataLoader.py](src_model/MapYourCity_ExampleDataLoader.py)
